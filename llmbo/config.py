...
PARAM_BOUNDS = {
    'I1': (3.0, 7.0),    # 第一阶段电流 [A]，避免边界奇点 (0, 8)
    'SOC1': (0.1, 0.7),    # 切换 SOC [0.1, 0.7]
    'I2': (1.0, 5.0),    # 第二阶段电流 [A]，避免边界奇点 (0, 8)
}
...
MOBO_CONFIG = {
    ...
    'reference_point': {
        ...
        'temp': 328.15,   
        'aging': 0.01,    # 从0.05改为0.008（贴近实际观测范围的2-3倍）
    },
    
    # 理想点（最好情况）
    'ideal_point': {
        'time': 2500.0,    # 最快 20 分钟 = 300 秒
        'temp': 298.15,   # 室温 25°C
        'aging': 1e-4,    # 接近无老化（不能为0，log10问题）
    }
}
