...
decision vectors are representative nondominated protocols from the archived
LLMBO-MO Chen2020 seed-8409 run.  No interpolated or synthetic trajectories are
used.
...
def _replay_protocols() -> Dict[str, Mapping[str, np.ndarray]]:
    """Replay every protocol with the paper's Chen2020 empirical-aging model."""
